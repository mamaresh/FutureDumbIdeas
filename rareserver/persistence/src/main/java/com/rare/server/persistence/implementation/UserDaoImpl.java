...
public class UserDaoImpl implements UserDao {
	...
	@Value(PersistenceConstants.KEYSPACE)
	String keyspace;
	...
	public List<String> getUserForGivenGoogleId(String googleId) throws DaoException {
		try {
			...
			Result<String> resultFromDatabase = accessor.getUserFriends(googleId);
			return resultFromDatabase.all();
	...
	private void doActualInsert(UserRegistrationDaoInput input) throws DaoException {
		...
		try {
			for (UserFriendDaoInput friend : input.getUserFriends()) {
