...
public class User {
	...
	@PartitionKey
	@Column(name = DaoConstants.GOOGLE_ID)
	private String googleId;

	@ClusteringColumn
	@Column(name = DaoConstants.FRIEND_GOOGLE_ID)
	private String friendGoogleId;

	@Column(name = DaoConstants.GENDER)
	private String gender;

	@Column(name = DaoConstants.URL)
	private String url;

	@Column(name = DaoConstants.TOTAL_FRIENDS)
	private Integer totalItems;

	@Column(name = DaoConstants.FRIEND_GOOGLE_URL)
	private String friendGoogleUrl;

	@Column(name = DaoConstants.FRIEND_NAME)
	private String friendName;

	@Column(name = DaoConstants.NAME)
